...
public class ApfsDirectory extends ApfsFSElement {
    ...
    public LinkedList<ApfsFSElement> getChildren() {
        Collections.sort(this.children, Comparator.comparing(ApfsFSElement::getName));
    ...
    public LinkedList<ApfsDirectory> getSubDirectories() {
        ...
        Collections.sort(subDirectories, Comparator.comparing(ApfsFSElement::getName));
    ...
    public LinkedList<ApfsFile> getFiles() {
        ...
        Collections.sort(files, Comparator.comparing(ApfsFSElement::getName));
        return files;
    }
