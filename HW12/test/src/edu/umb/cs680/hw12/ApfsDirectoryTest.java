...
public class ApfsDirectoryTest {
    ...
    public void verifyGetChildrenForRootInReverseAlphabeticalComparator() {
        ...
        expected.add(bin);
        expected.add(apps);
        assertEquals(expected, root.getChildren(new ReverseAlphabeticalComparator()));
    }
    ...
    public void verifyGetChildrenForRootInTimeStampComparator() {
        ...
        expected.add(bin);
        expected.add(home);
        assertEquals(expected, root.getChildren(new TimeStampComparator()));
    }
    ...
    public void verifyGetChildrenForHomeInReverseAlphabeticalComparator() {
        ...
        expected.add(pictures);
        expected.add(c);
        assertEquals(expected, home.getChildren(new ReverseAlphabeticalComparator()));
    }
    ...
    public void verifyGetSubDirectoriesForRootInReverseAlphabeticalComparator() {
        ...
        expected.add(bin);
        expected.add(apps);
        assertEquals(expected, root.getSubDirectories(new ReverseAlphabeticalComparator()));
    }
    ...
    public void verifyGetFilesForPicturesInReverseAlphabeticalComparator() {
        ...
        expected.add(b);
        expected.add(a);
        assertEquals(expected, pictures.getFiles(new ReverseAlphabeticalComparator()));
    }
    ...
    public void verifyGetFilesForPicturesInTimeStampComparator() {
        ...
        expected.add(a);
        expected.add(b);
        assertEquals(expected, pictures.getFiles(new TimeStampComparator()));
    }
